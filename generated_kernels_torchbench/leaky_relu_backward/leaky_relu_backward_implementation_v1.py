...
def leaky_relu_backward_kernel_impl(
    grad_output: torch.Tensor,
    self_tensor: torch.Tensor,
    negative_slope: float,
    self_is_result: bool,
) -> torch.Tensor:
    print("Hello from leaky_relu_backward_kernel_impl")
    ...
    assert grad_output.device.type == "cuda" and self_tensor.device.type == "cuda", (
