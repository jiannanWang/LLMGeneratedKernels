...
def _hardtanh_kernel(
    ptr_x,  # *only* tensor pointer
    numel,  # total number of elements
    min_val,
    max_val,  # scalar bounds
...
def hardtanh__kernel_impl(input_tensor: torch.Tensor, min_val: float, max_val: float):
    print("Hello from hardtanh__kernel_impl")
    """
