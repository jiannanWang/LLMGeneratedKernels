...
def _tanh_backward_kernel(
    ...
    off_g = i0 * gS0 + i1 * gS1 + i2 * gS2 + i3 * gS3 + i4 * gS4 + i5 * gS5 + i6 * gS6 + i7 * gS7
    off_y = i0 * yS0 + i1 * yS1 + i2 * yS2 + i3 * yS3 + i4 * yS4 + i5 * yS5 + i6 * yS6 + i7 * yS7
    off_o = i0 * oS0 + i1 * oS1 + i2 * oS2 + i3 * oS3 + i4 * oS4 + i5 * oS5 + i6 * oS6 + i7 * oS7
...
def tanh_backward_kernel_impl(grad_output: torch.Tensor, output: torch.Tensor) -> torch.Tensor:
        print("Hello from tanh_backward_kernel_impl")
    ...
    if grad_output.shape != output.shape:
        raise ValueError(
            f"Shape mismatch: grad_output.shape={tuple(grad_output.shape)}, "
