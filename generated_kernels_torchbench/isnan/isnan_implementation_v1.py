...
def _isnan_kernel_strided(
    ...
    S3,
    S4,
    S5,  # sizes for up to 6 dimensions (unused dims should be 1)
    ST0,
    ST1,
    ST2,
    ST3,
    ST4,
    ST5,  # strides (in element units of in_ptr's dtype) for up to 6 dims
...
def isnan_kernel_impl(x: torch.Tensor) -> torch.Tensor:
    print("Hello from isnan_kernel_impl")
