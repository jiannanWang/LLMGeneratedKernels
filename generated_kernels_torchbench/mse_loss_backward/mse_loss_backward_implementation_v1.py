...
def mse_loss_backward_kernel_impl(
    grad_output: torch.Tensor, input: torch.Tensor, target: torch.Tensor, reduction: int
):
    """
    ...
    """
    assert input.is_cuda and target.is_cuda and grad_output.is_cuda, (
