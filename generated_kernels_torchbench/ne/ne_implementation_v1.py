...
@triton.jit
def _ne_scalar_complex_kernel(
    x_ri_ptr, out_ptr, n_elements, scalar_real, scalar_imag, BLOCK_SIZE: tl.constexpr
):
    """
...
def ne_kernel_impl(tensor: torch.Tensor, scalar):
    print("Hello from ne_kernel_impl")
    """
    ...
    if dtype.is_complex:
        ...
        _ne_scalar_complex_kernel[grid](
            x_ri, out, n_elements, s_real, s_imag, BLOCK_SIZE=BLOCK_SIZE
        )
        return out
